...
function $spf$net$resource$key$$($type$$93$$, $key$$39_label$$9$$, $hash_opt_group$$) {
  $key$$39_label$$9$$ += $hash_opt_group$$ ? "-" + $hash_opt_group$$ : "";
  $hash_opt_group$$ = 5381;
  for (var $i$$13$$ = $key$$39_label$$9$$.length;$i$$13$$;) {
    $hash_opt_group$$ = 33 * $hash_opt_group$$ ^ $key$$39_label$$9$$.charCodeAt(--$i$$13$$);
  }
  return $type$$93$$ + "-" + ($hash_opt_group$$ >>> 0).toString(16);
}
function $spf$net$resource$label$$($url$$35$$) {
  return $url$$35$$ ? String($url$$35$$).replace(/[^\w]/g, "") : "";
}
function $spf$net$resource$status$set$$($status$$, $key$$40_type$$94$$, $url$$36$$, $opt_group$$1$$) {
  $key$$40_type$$94$$ = $spf$net$resource$key$$($key$$40_type$$94$$, $url$$36$$, $opt_group$$1$$);
  $spf$net$resource$status_$$[$key$$40_type$$94$$] = $status$$;
}
function $spf$net$resource$status$get$$($key$$41_type$$95$$, $url$$37$$, $opt_group$$2$$) {
  $key$$41_type$$95$$ = $spf$net$resource$key$$($key$$41_type$$95$$, $url$$37$$, $opt_group$$2$$);
  return $spf$net$resource$status_$$[$key$$41_type$$95$$];
}
...
function $spf$net$resource$url$set$$($key$$46_type$$101$$, $name$$59$$, $url$$43$$) {
  $key$$46_type$$101$$ = $spf$net$resource$key$$($key$$46_type$$101$$, $name$$59$$);
  $spf$net$resource$url_$$[$key$$46_type$$101$$] = $url$$43$$;
}
function $spf$net$resource$url$get$$($type$$102$$, $name$$60$$) {
  var $key$$47$$ = $spf$net$resource$key$$($type$$102$$, $name$$60$$);
  return $spf$net$resource$url_$$[$key$$47$$];
}
...
function $spf$nav$response$process$$($url$$55$$, $response$$1$$, $opt_info$$, $opt_callback$$8$$) {
  ...
  $response$$1$$.head && ($fn$$17_num$$5$$ = $spf$bind$$(function($head$$, $timing$$) {
    ...
    $spf$tasks$suspend$$($key$$49$$);
    $spf$nav$response$installScripts_$$($extracted$$, function() {
      $timing$$.spfProcessHead = $spf$now$$();
      $spf$debug$debug$$("    head js");
      $spf$tasks$resume$$($key$$49$$, $sync$$);
      $spf$debug$debug$$("  process task done: head");
    });
  }, null, $response$$1$$.head, $response$$1$$.timing), $fn$$17_num$$5$$ = $spf$tasks$add$$($key$$49$$, $fn$$17_num$$5$$), $spf$debug$debug$$("  process task queued: head", $fn$$17_num$$5$$));
  ...
  }, null, $response$$1$$.attr, $response$$1$$.timing), $fn$$17_num$$5$$ = $spf$tasks$add$$($key$$49$$, $fn$$17_num$$5$$), $spf$debug$debug$$("  process task queued: attr", $fn$$17_num$$5$$));
    ...
    $fn$$17_num$$5$$ = $spf$bind$$(function($id$$10$$, $body$$1$$) {
      ...
      if ($animation_el$$12$$) {
        ...
        $id$$10$$), $spf$tasks$add$$($animation_el$$12$$.key, $spf$bind$$($spf$nav$response$runAnimation_$$, null, $animation_el$$12$$), 17), $spf$debug$debug$$("  process queued run animation", $id$$10$$), $spf$tasks$add$$($animation_el$$12$$.key, $spf$bind$$($spf$nav$response$completeAnimation_$$, null, $animation_el$$12$$), $animation_el$$12$$.duration), $spf$debug$debug$$("  process queued complete animation", $id$$10$$), $spf$tasks$add$$($animation_el$$12$$.key, $spf$bind$$(function() {
          $installScripts$$();
          $spf$tasks$resume$$($key$$49$$, $sync$$);
        }, null), 0), $spf$tasks$run$$($animation_el$$12$$.key)) : ($animationClass_htmlHandler$$ = $spf$config$values$$["experimental-html-handler"]) ? ($spf$tasks$suspend$$($key$$49$$), $animationClass_htmlHandler$$($extracted$$1$$.html, $animation_el$$12$$, function() {
          $installScripts$$();
          $spf$tasks$resume$$($key$$49$$, $sync$$);
        })) : ($animation_el$$12$$.innerHTML = $extracted$$1$$.html, $installScripts$$());
      }
    }, null, $id$$8$$, $fragments_numFragments$$[$id$$8$$], $response$$1$$.timing), $fn$$17_num$$5$$ = $spf$tasks$add$$($key$$49$$, $fn$$17_num$$5$$), $spf$debug$debug$$("  process task queued: body", $id$$8$$, $fn$$17_num$$5$$);
  }
  ...
  }, null, $response$$1$$.foot, $response$$1$$.timing, $fragments_numFragments$$), $fn$$17_num$$5$$ = $spf$tasks$add$$($key$$49$$, $fn$$17_num$$5$$), $spf$debug$debug$$("  process task queued: foot", $fn$$17_num$$5$$)) : $fragments_numFragments$$ && ($fn$$17_num$$5$$ = $spf$bind$$(function($timing$$4$$) {
    $timing$$4$$.spfProcessBody = $spf$now$$();
    $spf$debug$debug$$("  process task done: timing-for-body");
  }, null, $response$$1$$.timing), $fn$$17_num$$5$$ = $spf$tasks$add$$($key$$49$$, $fn$$17_num$$5$$), $spf$debug$debug$$("  process task queued: timing-for-body", $fn$$17_num$$5$$));
  $opt_callback$$8$$ && ($fn$$17_num$$5$$ = $spf$tasks$add$$($key$$49$$, $spf$bind$$($opt_callback$$8$$, null, $url$$55$$, $response$$1$$)), $spf$debug$debug$$("  process task queued: callback", $fn$$17_num$$5$$));
  $spf$debug$debug$$("  process run", $key$$49$$, $sync$$);
  $spf$tasks$run$$($key$$49$$, $sync$$);
}
function $spf$nav$response$preprocess$$($url$$56$$, $response$$2$$, $key$$50_opt_info$$1$$, $opt_callback$$9$$) {
  $spf$debug$info$$("nav.response.preprocess ", $response$$2$$);
  $key$$50_opt_info$$1$$ = "preprocess " + $spf$url$absolute$$($url$$56$$);
  var $fn$$18$$;
  ...
  }, null, $response$$2$$.head), $spf$tasks$add$$($key$$50_opt_info$$1$$, $fn$$18$$), $spf$debug$debug$$("  preprocess task queued: head"));
  ...
  for ($id$$11$$ in $fragments$$1$$) {
    ...
    }, null, $id$$11$$, $fragments$$1$$[$id$$11$$]), $spf$tasks$add$$($key$$50_opt_info$$1$$, $fn$$18$$), $spf$debug$debug$$("  preprocess task queued: body", $id$$11$$));
  }
  ...
  }, null, $response$$2$$.foot), $spf$tasks$add$$($key$$50_opt_info$$1$$, $fn$$18$$), $spf$debug$debug$$("  preprocess task queued: foot"));
  $opt_callback$$9$$ && ($spf$tasks$add$$($key$$50_opt_info$$1$$, $spf$bind$$($opt_callback$$9$$, null, $url$$56$$, $response$$2$$)), $spf$debug$debug$$("  preprocess task queued: callback"));
  $spf$tasks$run$$($key$$50_opt_info$$1$$);
}
...
function $spf$net$xhr$send$$($addContentTypeFormUrlEncoded_method$$2$$, $url$$61$$, $data$$34$$, $isFormData_opt_options$$17$$) {
    ...
    if ($xhr$$.readyState == $spf$net$xhr$State$HEADERS_RECEIVED$$) {
      ...
      if ("json" == $xhr$$.responseType) {
        ...
        if (-1 < ($xhr$$.getResponseHeader("Transfer-Encoding") || "").toLowerCase().indexOf("chunked")) {
          ...
          var $chunk$$1_firefoxSpdy$$inline_107_timing$$5$$ = $xhr$$.getResponseHeader("X-Firefox-Spdy"), $chromeSpdy$$inline_109_navTiming$$inline_108$$ = window.performance && window.performance.getEntriesByType && window.performance.getEntriesByType("navigation")[0], $chromeSpdy$$inline_109_navTiming$$inline_108$$ = window.chrome && (window.PerformanceNavigationTiming ? $chromeSpdy$$inline_109_navTiming$$inline_108$$ && -1 < ["h2", "hq"].indexOf($chromeSpdy$$inline_109_navTiming$$inline_108$$.nextHopProtocol) : 
          chrome.loadTimes && chrome.loadTimes().wasFetchedViaSpdy);
          $chunked$$ = !(!$chunk$$1_firefoxSpdy$$inline_107_timing$$5$$ && !$chromeSpdy$$inline_109_navTiming$$inline_108$$);
        }
      }
  ...
  if ($options$$4$$.headers) {
    for (var $key$$51$$ in $options$$4$$.headers) {
      $xhr$$.setRequestHeader($key$$51$$, $options$$4$$.headers[$key$$51$$]), "content-type" == $key$$51$$.toLowerCase() && ($addContentTypeFormUrlEncoded_method$$2$$ = !1);
    }
  }
...
function $spf$nav$request$handleCompleteFromXHR_$$($url$$66$$, $options$$8$$, $timing$$9$$, $chunking$$3_i$$14$$, $part$$3_xhr$$5$$) {
  "json" == $part$$3_xhr$$5$$.responseType ? $spf$debug$debug$$("nav.request.handleCompleteFromXHR_ ", $url$$66$$, $part$$3_xhr$$5$$.response) : $spf$debug$debug$$("nav.request.handleCompleteFromXHR_ ", $url$$66$$, {extra:$chunking$$3_i$$14$$.$extra$, complete:$part$$3_xhr$$5$$.responseText});
  ...
  if ($part$$3_xhr$$5$$.resourceTiming) {
    if ("load" == $options$$8$$.type) {
      for (var $key$$53_value$$57$$ in $part$$3_xhr$$5$$.resourceTiming) {
        $timing$$9$$[$key$$53_value$$57$$] = $part$$3_xhr$$5$$.resourceTiming[$key$$53_value$$57$$];
      }
    } else {
      if (window.performance && window.performance.timing && ($navigationStart_t$$ = window.performance.timing.navigationStart, $navigationStart_t$$ + $part$$3_xhr$$5$$.resourceTiming.startTime >= $timing$$9$$.startTime)) {
        for (var $metric$$ in $part$$3_xhr$$5$$.resourceTiming) {
          $key$$53_value$$57$$ = $part$$3_xhr$$5$$.resourceTiming[$metric$$], void 0 !== $key$$53_value$$57$$ && ($spf$string$endsWith$$($metric$$, "Start") || $spf$string$endsWith$$($metric$$, "End") || "startTime" == $metric$$) && ($timing$$9$$[$metric$$] = $navigationStart_t$$ + Math.round($key$$53_value$$57$$));
        }
      }
    }
  }
  "load" != $options$$8$$.type && ($timing$$9$$.navigationStart = $timing$$9$$.startTime);
  $chunking$$3_i$$14$$.complete.length && ($chunking$$3_i$$14$$.$extra$ = $spf$string$trim$$($chunking$$3_i$$14$$.$extra$), $chunking$$3_i$$14$$.$extra$ && $spf$nav$request$handleChunkFromXHR_$$($url$$66$$, $options$$8$$, $timing$$9$$, $chunking$$3_i$$14$$, $part$$3_xhr$$5$$, "", !0));
  ...
  if ($options$$8$$.$onPart$ && 1 < $parts$$4_response$$6$$.length) {
    for ($chunking$$3_i$$14$$ = $chunking$$3_i$$14$$.complete.length;$chunking$$3_i$$14$$ < $parts$$4_response$$6$$.length;$chunking$$3_i$$14$$++) {
      $spf$debug$debug$$("    parsed part", $parts$$4_response$$6$$[$chunking$$3_i$$14$$]), $part$$3_xhr$$5$$ = $parts$$4_response$$6$$[$chunking$$3_i$$14$$], $part$$3_xhr$$5$$.timing || ($part$$3_xhr$$5$$.timing = {}), $part$$3_xhr$$5$$.timing.spfCached = !!$timing$$9$$.spfCached, $part$$3_xhr$$5$$.timing.spfPrefetched = !!$timing$$9$$.spfPrefetched, $options$$8$$.$onPart$($url$$66$$, $part$$3_xhr$$5$$);
    }
  }
...
;function $spf$nav$getAncestorWithLinkClass_$$($element$$8$$) {
  return $element$$8$$.closest ? $element$$8$$.closest("." + $spf$config$values$$["link-class"]) : $spf$dom$getAncestor$$($element$$8$$, function($node$$8$$) {
...
function $spf$nav$getAncestorWithNoLinkClass_$$($element$$9$$) {
  return $element$$9$$.closest ? $element$$9$$.closest("." + $spf$config$values$$["nolink-class"]) : $spf$dom$getAncestor$$($element$$9$$, function($node$$9$$) {
...
function $spf$nav$getAncestorWithHref_$$($element$$10$$, $parent$$3$$) {
  return $spf$dom$getAncestor$$($element$$10$$, function($node$$10$$) {
    return $node$$10$$.href && 0 > ["img", "use"].indexOf($node$$10$$.tagName.toLowerCase());
  }, $parent$$3$$);
}
...
function $spf$nav$handleLoadRedirect_$$($isPrefetch$$3_redirectFn$$, $options$$27$$, $info$$16$$, $redirectUrl$$1$$) {
  ...
  var $redirectOpts$$ = {};
  $spf$array$each$$([$spf$nav$Callback$ERROR$$, $spf$nav$Callback$REQUEST$$, $spf$nav$Callback$PART_PROCESS$$, $spf$nav$Callback$PART_DONE$$, $spf$nav$Callback$PROCESS$$, $spf$nav$Callback$DONE$$], function($key$$55$$) {
    $redirectOpts$$[$key$$55$$] = $options$$27$$[$key$$55$$];
  });
...
function $spf$nav$cancelAllPrefetchesExcept$$($absoluteUrl$$5_opt_skipUrl$$) {
  ...
  for (var $key$$56$$ in $prefetches$$3$$) {
