...
function $spf$net$resource$key$$($type$$93$$, $key$$30_label$$9$$, $hash_opt_group$$) {
  $key$$30_label$$9$$ += $hash_opt_group$$ ? "-" + $hash_opt_group$$ : "";
  $hash_opt_group$$ = 5381;
  for (var $i$$12$$ = $key$$30_label$$9$$.length;$i$$12$$;) {
    $hash_opt_group$$ = 33 * $hash_opt_group$$ ^ $key$$30_label$$9$$.charCodeAt(--$i$$12$$);
  }
  return $type$$93$$ + "-" + ($hash_opt_group$$ >>> 0).toString(16);
}
function $spf$net$resource$status$set$$($status$$, $key$$31_type$$94$$, $url$$33$$, $opt_group$$1$$) {
  $key$$31_type$$94$$ = $spf$net$resource$key$$($key$$31_type$$94$$, $url$$33$$, $opt_group$$1$$);
  $spf$net$resource$status_$$[$key$$31_type$$94$$] = $status$$;
}
function $spf$net$resource$status$get$$($key$$32_type$$95$$, $url$$34$$, $opt_group$$2$$) {
  $key$$32_type$$95$$ = $spf$net$resource$key$$($key$$32_type$$95$$, $url$$34$$, $opt_group$$2$$);
  return $spf$net$resource$status_$$[$key$$32_type$$95$$];
}
function $spf$net$resource$url$get$$($type$$102$$, $name$$60$$) {
  var $key$$38$$ = $spf$net$resource$key$$($type$$102$$, $name$$60$$);
  return $spf$net$resource$url_$$[$key$$38$$];
}
